...
import { Upload, Sparkles, Copy, Check, Pencil, Save, Mic, Loader2, LogIn } from 'lucide-react'
          ...
          <div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                />
                <button type="button" onClick={descricaoSpeech.toggleListening} disabled={descricaoSpeech.status === 'loading' || limitReached}
                  style={{
